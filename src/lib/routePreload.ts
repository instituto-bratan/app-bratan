...
const routeLoaders = {
  ...
  governancaIa: namedPage(() => import("@/features/admin/GovernancaIaPage"), "GovernancaIaPage"),
  ...
  vozDoDoutor: namedPage(() => import("@/features/admin/VozDoDoutorPage"), "VozDoDoutorPage"),
...
export function routeKeyForHref(href: string): RoutePreloadKey | null {
  ...
  if (pathname === "/administracao/ia") return "governancaIa";
  ...
  if (pathname === "/administracao/portal") return "vozDoDoutor";

  ...
  },
  {
    ...
    guide: {
      ...
      steps: [
        ...
        "No fechamento do mês, se quiser reconhecer esse dinheiro como resultado, escolha o mês em 'Somar este caixa no lucro do mês' e aperte o botão — vale só para o mês escolhido.",
      ...
      tips: [
        ...
        "Somar no lucro NÃO tira dinheiro do cofre: é decisão de resultado, mês a mês, e dá para desfazer. O app sugere só o dinheiro que ainda não foi reconhecido, para o mesmo valor nunca contar em dois meses.",
      ],
    },
  },
  {

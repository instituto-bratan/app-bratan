...
export const pageGuides: Array<{ pattern: string; guide: PageGuide }> = [
  ...
  },
  {
    ...
    guide: {
      ...
      steps: [
        ...
        "Quando o pagamento acontecer, toque em 'Recebi': informe quanto, como recebeu (PIX, cartão, dinheiro) e responda se a dívida já tem comanda.",
        "Dívida SEM comanda: o app lança a comanda e o dinheiro entra no faturamento e na P12. Dívida COM comanda: só dá baixa, porque o faturamento já contou.",
      ],
      tips: [
        ...
        "A pergunta da comanda é o que separa 'dinheiro novo' de 'dinheiro já contado' — errar nela infla ou esconde o faturamento.",
        "Dinheiro vivo sem comanda vai para o caixa do Crediário; para virar lucro do mês, use o botão daquela tela.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    guide: {
      ...
      steps: [
        "Abra a tela e olhe a Fila do dia: vencidas, vencem hoje, próximos 7 dias e compras que chegaram/faltam resolver — cada cartão tem 'Paguei', 'Adiar', 'Chegou' ou 'Virar conta'.",
        "Chegou boleto, nota ou PIX? Cole o texto (ou solte o PDF) em 'Lançar rápido': valor, vencimento e beneficiário entram sozinhos; você confere e escolhe a categoria P12.",
        "Compra de medicação/insumo: use o atalho do fornecedor (Stin, Biòs, Victa…) e marque 'Também é uma compra' — a compra nasce ligada à conta, com entrega e estoque.",
        "Vários arquivos de uma vez? Solte na 'Caixa de entrada'; eles ficam listados até virar conta ou serem descartados.",
        "A planilha do mês continua embaixo, para conferir, corrigir, anexar a NF e fechar.",
      ],
      tips: [
        "A Fila do dia é derivada das contas e compras que já existem — nada é digitado nela; o resumo aparece também na página Hoje.",
        "Conta lançada depois de vencer é sinal de que o boleto chegou por fora do app: use a Caixa de entrada no dia em que ele chegar.",
        "Toda conta entra com uma categoria P12 obrigatória — é isso que faz o número bater sozinho.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    guide: {
      ...
      steps: [
        ...
        "Conte o dinheiro do cofre e digite em 'Conferir o cofre': o app mostra a diferença e aponta os lançamentos com cara de duplicata.",
        "No fechamento do mês, se quiser reconhecer esse dinheiro, escolha o mês em 'Somar este caixa no lucro do mês' e aperte o botão — o valor soma no FATURAMENTO, na meta e no lucro daquele mês.",
        "Se um recebimento foi lançado duas vezes (ou com a forma errada), clique em 'Estornar este' — o valor volta a ficar em aberto no lembrete.",
      ...
      tips: [
        ...
        "Recebimento que a recepção lançou pela comanda não entra aqui: já está no faturamento, e contar de novo duplicaria o dinheiro.",
        "Estorno é registrado (quem fez, quando e o motivo). Nada é apagado sem você clicar.",
        "Somar NÃO tira dinheiro do cofre: é decisão de resultado, mês a mês, e dá para desfazer. O app sugere só o que ainda não foi reconhecido, para o mesmo valor nunca contar em dois meses — nem no faturamento, nem no lucro.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    guide: {
      ...
      steps: [
        ...
        "Ao mover para 'Consulta agendada/confirmada', a DATA da consulta é obrigatória: com ela o paciente entra sozinho no 3·1 da recepção (confirmação −3 e lembrete −1).",
        "Remarcou a consulta? Mova o card de novo com a data nova — as tarefas antigas são canceladas sozinhas.",
  ...
  },
  {
    ...
    guide: {
      ...
      tips: [
        ...
        "A faixa vermelha 'fora do 3·1' mostra agendados sem confirmação ativa — informe a data e corrija em um toque; é o furo que gera erro de agenda.",
        "Se a inscrição for bloqueada pela regra de 1 cadência por paciente, a tela agora AVISA qual régua está ativa — nada de sucesso falso.",
      ],
    },
  },
  {

...
function LiquidButton({ className, variant, size, asChild = false, children, ...props }: LiquidButtonProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute left-0 top-0 -z-10 h-full w-full overflow-hidden rounded-md bg-white/45"
...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#1f2619] to-[#7A895E]",
    inner: "bg-gradient-to-b from-[#FAF8F1] via-[#4D563B] to-[#DAD7C8]",
    button: "bg-gradient-to-b from-brand-musgo to-brand-oliva",
    textColor: "text-brand-papel",
    textShadow: "[text-shadow:_0_-1px_0_rgb(43_46_36_/_100%)]",
  },
  success: {

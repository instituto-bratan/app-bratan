...
test("sinal de R$ 200 existe no catálogo, ao lado do de R$ 500 (áudio da CEO)", () => {
  ...
  // mesma fração de lucro bruto do sinal de 500 (81,6% do preço)
  assert.equal(Math.round((duzentos.lucroBruto / duzentos.preco) * 1000) / 1000, Math.round((408 / 500) * 1000) / 1000);
